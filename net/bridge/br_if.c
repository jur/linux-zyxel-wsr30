...
struct br_fastbat_ops  _br_fastbat_ops = {
	.fastbat_dispatch = NULL, 
	.fastbat_filter_input_packet = NULL, 
	.fastbat_list_search = NULL, 
	.fastbat_grab_real_ethhdr = NULL, 
	.fastbat_show_raw_data = NULL, 
	.fastbat_local_search = NULL, 
	.fastbat_chk_and_add_local_entry = NULL, 
};
EXPORT_SYMBOL(_br_fastbat_ops);
#endif
