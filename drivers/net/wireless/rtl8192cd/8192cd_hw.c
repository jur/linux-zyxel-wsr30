...
#if 1 // ZYXEL workaround for preventing that the priv is NULL address makes kernel panic.
    if (priv < 0x80000000) {
        WARN_ON(1);
        return 0;
    }
...
enum efuse_cmd_type {
	...
	TYPE_HW_BT_ADDR,
	TYPE_HW_BT_1M_TX_POWER,
	TYPE_HW_BT_2M_TX_POWER,
	TYPE_HW_BT_3M_TX_POWER,
	TYPE_HW_BT_LE_TX_POWER,
	TYPE_EFUSE_CMD_END
};
...
struct efuse_cmd_t efuse_cmd_8812e[] = {
	...
	{"HW_BT_ADDR", TYPE_HW_BT_ADDR, EEPROM_8812_BT_MACADDRESS},
	{"HW_BT_1M_TX_POWER", TYPE_HW_BT_1M_TX_POWER, EEPROM_BT_1MTxPower},
	{"HW_BT_2M_TX_POWER", TYPE_HW_BT_2M_TX_POWER, EEPROM_BT_2MTxPower},
	{"HW_BT_3M_TX_POWER", TYPE_HW_BT_3M_TX_POWER, EEPROM_BT_3MTxPower},
	{"HW_BT_LE_TX_POWER", TYPE_HW_BT_LE_TX_POWER, EEPROM_BT_LETxPower},
};
#endif
...
static void shadowMapWrite(struct rtl8192cd_priv *priv, u1Byte index, u1Byte *value, u1Byte *hwinfo)
{
	...
	case TYPE_HW_BT_ADDR:
	{
		for( i = 0 ; i < MACADDRLEN ; ++i ) 		
			get_array_val(&hwinfo[offset+i], &value[i*2], 2);
		break;
	}
	case TYPE_HW_BT_1M_TX_POWER:
	case TYPE_HW_BT_2M_TX_POWER:
	case TYPE_HW_BT_3M_TX_POWER:		
	case TYPE_HW_BT_LE_TX_POWER:
	{
		get_array_val(&hwinfo[offset], value, 2);
		break;
	}
...
//		return;
	...
	if (wlan_idx >= ARRAY_SIZE(wlan_device))
		return;
#else
	wlan_idx = 0;
#endif
