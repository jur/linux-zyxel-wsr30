...
#if defined(CONFIG_USB_HCI) && defined(CONFIG_PCI_HCI)//CONFIG_RTL_TRIBAND_SUPPORT
...
#if IS_EXIST_RTL8192EE || IS_EXIST_RTL8192EU || IS_EXIST_RTL8814AE ||IS_EXIST_RTL8197FEM ||IS_EXIST_RTL8822BE
