...
EXTERN void update_AC_STA_RAMask(struct rtl8192cd_priv *priv);
#endif
...
#if defined(CONFIG_USB_HCI)
EXTERN void signin_beacon_desc_usb(struct rtl8192cd_priv * priv,unsigned int * beaconbuf,unsigned int frlen);
#endif
...
EXTERN int zyxel_netlink_init(void);
EXTERN void zyxel_netlink_exit(void);
