...
struct wifi_mesh_node {
	...
	s8	dirty;
	u8	band;						/*0/2/5*/
	u8	orig[ETH_ALEN];				//mac of orig
	u8	addr[ETH_ALEN];				//mac of input/output iface
	u32	rssi_metric;
	u32	cu_metric;
	u32	noise_metric;
	u32	ewma_metric;				//finial metric value from rssi/cu/noise
	u32	throughput;
...
#if defined(CONFIG_SLOT_0_8822BE)
#define TRIBAND_MESH_SINGLE_IFACE
#endif
...
#endif //CONFIG_RTL_TRIBAND_SUPPORT && CONFIG_RTK_MESH
