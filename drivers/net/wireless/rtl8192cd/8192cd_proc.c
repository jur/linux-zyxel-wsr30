...
#endif			
{
/* ZYXEL debug, move the snippet to the begin of function.*/
...
#if 0 //!defined(SMP_SYNC) || (defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI))        
    unsigned long flags=0;
#endif
...
#if defined(CONFIG_RTL_TRIBAND_001) && defined(CONFIG_RTK_MESH)//don't show mesh point in sta_info
...
/* Hotspot 2.0 Release 1 */
	...
	PRINT_SINGL_ARG("    limit BW: ", priv->limit_bw_20M, "%d");	
#endif	
	RESTORE_INT(flags);
