...
#if defined(CONFIG_RTL_TRIBAND_SUPPORT)
#if 0
#define _8192CD_TRIBNAD_UTIL_RW_H_
#include "8192cd_triband.h"
#undef _8192CD_TRIBNAD_UTIL_RW_H_
#endif
...
#else//TRIBAND_OPS
#define RTL_R8(reg)		\
    priv->hci_ops->read8(priv, reg)

#define RTL_R16(reg)	\
	priv->hci_ops->read16(priv, reg)

#define RTL_R32(reg)	\
	priv->hci_ops->read32(priv, reg)

#define RTL_W8(reg, val8)	\
    priv->hci_ops->write8(priv, reg, val8)

#define RTL_W16(reg, val16)	\
    priv->hci_ops->write16(priv, reg, val16)

#define RTL_W32(reg, val32)	\
   priv->hci_ops->write32(priv, reg, val32)
#endif
...
#if 0//defined(CONFIG_USB_HCI) || defined(CONFIG_SDIO_HCI)
...
#if 0//defined(UNIVERSAL_REPEATER) || defined(HS2_SUPPORT)
