...
#if defined(CONFIG_RTL_FLASH_DUAL_IMAGE_ENABLE)
	,
#if defined(CONFIG_ZYXEL_RTL_FLASH_DUAL_IMAGE_REPLACEMENT)
	{
	    name:           "config",
	    size:           0x800000,
	    offset:         0x00000000+RTK_FLASH_SIZE,
...
#endif
#if defined(CONFIG_ZYXEL_NAND_FLASH_APPEND_APP_PARTITION)
	,
	{
	    name:           "app",
	    size:           (CONFIG_ZYXEL_NAND_FLASH_APPEND_APP_PARTITION_SIZE),
	    offset:         MTDPART_OFS_APPEND,
	}
#endif
#if defined(CONFIG_ZYXEL_NAND_FLASH_APPEND_WSR_PARTITION)
	,
	{
	    name:           "wsr",
	    size:           (CONFIG_ZYXEL_NAND_FLASH_APPEND_WSR_PARTITION_SIZE),
	    offset:         MTDPART_OFS_APPEND,
	}
#endif
};
...
#ifdef CONFIG_RTL_FLASH_DUAL_IMAGE_ENABLE
#ifndef CONFIG_ZYXEL_RTL_FLASH_DUAL_IMAGE_DISABLE_CHECK_ROOTFS2_SIZE
	size = 0;
