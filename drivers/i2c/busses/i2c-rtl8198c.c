...
#if defined(CONFIG_RTL8198C_I2C_SUPPORT_LEDS_LP5562)

#include <linux/leds.h>
#include <linux/platform_data/leds-lp55xx.h>

static const u8 mode_slow_blinking[] = {
    0x40, 0x00, 0x60, 0x00, 0x40, 0xFF, 0x60, 0x00,
};

static const u8 mode_fast_blinking[] = {
    0x40, 0x00, 0x44, 0x00, 0x40, 0xFF, 0x44, 0x00,
};

struct lp55xx_predef_pattern wsr30_leds_patterns[] = {
	{
	  .r = mode_slow_blinking,
	  .size_r = ARRAY_SIZE(mode_slow_blinking),
	},
	{
	  .r = mode_fast_blinking,
	  .size_r = ARRAY_SIZE(mode_fast_blinking),
	},
	{
	  .g = mode_slow_blinking,
	  .size_g = ARRAY_SIZE(mode_slow_blinking),
	},
	{
	  .g = mode_fast_blinking,
	  .size_g = ARRAY_SIZE(mode_fast_blinking),
	},
	{
	  .b = mode_slow_blinking,
	  .size_b = ARRAY_SIZE(mode_slow_blinking),
	},
	{
	  .b = mode_fast_blinking,
	  .size_b = ARRAY_SIZE(mode_fast_blinking),
	},
};

#if defined(CONFIG_ZYXEL_LEDS_LP5562_W_PRED_PAT)
struct lp55xx_predef_pattern wsr30_leds_wpatterns[] = {
	{
	  .r = mode_slow_blinking,
	  .size_r = ARRAY_SIZE(mode_slow_blinking),
	},
...
static struct lp55xx_led_config wsr30_leds_config[] = {
	{
		.name 		= "R",
		.chan_nr	= 0,
		.led_current	= 0xDF,
...
static struct lp55xx_platform_data lp5562_platform_data = {
        .led_config     = wsr30_leds_config,
        .num_channels   = ARRAY_SIZE(wsr30_leds_config),
        .setup_resources   = lp5562_setup,
        .release_resources = lp5562_release,
        .enable            = lp5562_enable,
	.patterns = wsr30_leds_patterns,
	.num_patterns  = ARRAY_SIZE(wsr30_leds_patterns),
#if defined(CONFIG_ZYXEL_LEDS_LP5562_W_PRED_PAT)
	.wpatterns = wsr30_leds_wpatterns,
	.num_wpatterns  = ARRAY_SIZE(wsr30_leds_wpatterns),
#endif
};

static struct i2c_board_info  wsr30_leds_board_info = {
	I2C_BOARD_INFO("lp5562", 0x30),
	.platform_data = &lp5562_platform_data,
};

#elif defined(CONFIG_RTL8198C_I2C_SUPPORT_LEDS_LP55231)
...
static const u8 mode_slow_blinking_r[] = {
    0x00, 0x15, 0x9C, 0x00, 0x40, 0xFF, 0x7E, 0x00, 0x40, 0x00, 0x7E, 0x00, 0xA0, 0x01,
};

static const u8 mode_fast_blinking_r[] = {
    0x00, 0x15, 0x9C, 0x00, 0x40, 0xFF, 0x50, 0x00, 0x40, 0x00, 0x50, 0x00, 0xA0, 0x01,
};
static const u8 mode_slow_blinking_g[] = {
    0x00, 0x2A, 0x9C, 0x00, 0x40, 0xFF, 0x7E, 0x00, 0x40, 0x00, 0x7E, 0x00, 0xA0, 0x01,
};

static const u8 mode_fast_blinking_g[] = {
    0x00, 0x2A, 0x9C, 0x00, 0x40, 0xFF, 0x50, 0x00, 0x40, 0x00, 0x50, 0x00, 0xA0, 0x01,
};
static const u8 mode_slow_blinking_b[] = {
    0x01, 0xC0, 0x9C, 0x00, 0x40, 0xFF, 0x7E, 0x00, 0x40, 0x00, 0x7E, 0x00, 0xA0, 0x01,
};

static const u8 mode_fast_blinking_b[] = {
    0x01, 0xC0, 0x9C, 0x00, 0x40, 0xFF, 0x50, 0x00, 0x40, 0x00, 0x50, 0x00, 0xA0, 0x01,
};

#if defined(CONFIG_LEDS_LP5523_EXTENDED_FW)
static const u8 mode_breathing_white[] = {
	0x01, 0xFF, 0x9F, 0x80, 0x40, 0xFF, 0x19, 0xFF, 0x18, 0xFF, 0xA0, 0x02,
};

static const u8 mode_bluetooth_ready[] = {
	0x00,0x15,0x00,0x02,0x00,0x28,0x01,0xC0,0x9F,0x80,0x40,0x00,0x9F,0x81,0x40,0xFF,
	0x9F,0x82,0x40,0x64,0x9F,0x83,0x40,0xFF,0x7E,0x00,0xA0,0x08,
};

static const u8 mode_bluetooth_configuring[] = {
	0x00, 0x15, 0x01, 0xC2, 0x00, 0x28, 0x9F, 0x80, 0x40, 0x00, 0x9F, 0x81, 0x40, 0xFF, 0x19, 0xFF,
	0x10, 0xFF, 0xA0, 0x04, 0x9F, 0x82, 0x40, 0x64, 0x3F, 0x64, 0x28, 0x64, 0xA0, 0x02,
};

static const u8 mode_fw_upgrade[] = {
	0x00, 0x3F, 0x01, 0xC0, 0x9F, 0x81, 0x40, 0x00, 0x9F, 0x80, 0x40, 0xFF, 0x19, 0xFF, 0x10, 0xFF,
	0xA0, 0x04,
};

static const u8 mode_ready[] = {
	0x00, 0x01, 0x00, 0x02, 0x00, 0x40, 0x00, 0x04, 0x00, 0x08, 0x00, 0x80, 0x00, 0x10, 0x00, 0x20,
	0x01, 0x00, 0x9F, 0x81, 0x40, 0x00, 0x9F, 0x82, 0x40, 0xFF, 0x9F, 0x80, 0x40, 0xC8, 0x15, 0xC8,
	0x60, 0x00, 0x60, 0x00, 0x60, 0x00, 0x60, 0x00, 0x14, 0xC8, 0xA0, 0x06, 0x9F, 0x84, 0x40, 0x00,
	0x9F, 0x85, 0x40, 0xFF, 0x9F, 0x83, 0x40, 0x00, 0x60, 0x00, 0x60, 0x00, 0x60, 0x00, 0x60, 0x00,
	0x14, 0xC8, 0x15, 0xC8, 0xA0, 0x06, 0x9F, 0x87, 0x40, 0x00, 0x9F, 0x88, 0x40, 0xFF, 0x9F, 0x86,
	0x40, 0x00, 0x14, 0xC8, 0x15, 0xC8, 0x60, 0x00, 0x60, 0x00, 0x60, 0x00, 0x60, 0x00, 0xA0, 0x06,
};

static const u8 mode_wps[] = {
	0x01, 0xD5, 0x00, 0x2A, 0x9F, 0x81, 0x40, 0x00, 0x9F, 0x80, 0x40, 0xFF, 0x19, 0xFF, 0x10, 0xFF,
	0xA0, 0x04,
};

static const u8 mode_reset[] = {
	0x01, 0xC0, 0x00, 0x3F, 0x9F, 0x80, 0x40, 0x00, 0x9F, 0x81, 0x40, 0xFF, 0x50, 0x00, 0x40, 0x00,
	0x50, 0x00, 0xA0, 0x03,
};

static const u8 mode_error[] = {
	0x01, 0xEA, 0x00, 0x15, 0x9F, 0x80, 0x40, 0x00, 0x9F, 0x81, 0x40, 0xFF, 0x7E, 0x00, 0xA0, 0x04,
};
...
struct lp55xx_predef_pattern wsr30_leds_patterns[] = {
	...
	{ // 9, white blinking
	  .r = mode_breathing_white,
	  .size_r = ARRAY_SIZE(mode_breathing_white),
#if defined(CONFIG_LEDS_LP5523_EXTENDED_FW)
	  .eng_start_addr = 0x1,
#endif
	},
	...
	{ // 11, blue blinking
	  .r = mode_bluetooth_configuring,
	  .size_r = ARRAY_SIZE(mode_bluetooth_configuring),
	  .eng_start_addr = 0xA03,
	},
	{ // 12, amber blinking
	  .r = mode_fw_upgrade,
	  .size_r = ARRAY_SIZE(mode_fw_upgrade),
	  .eng_start_addr = 0x2,
	},
	...
	{ // 14, pink & blue roate
	  .r = mode_ready,
	  .size_r = ARRAY_SIZE(mode_ready),
	  .eng_start_addr = 0x231609,
	},
	{ // 15, pink blinking
	  .r = mode_wps,
	  .size_r = ARRAY_SIZE(mode_wps),
	  .eng_start_addr = 0x2,
	},
	{ // 16, red solid
	  .r = mode_error,
...
#endif // CONFIG_LEDS_LP5523_PREDEFINED_PATTERNS
...
static struct i2c_board_info  wsr30_leds_board_info = {
	I2C_BOARD_INFO("lp55231", 0x32),
	.platform_data = &lp5523_platform_data,
};

#endif /* CONFIG_RTL8198C_I2C_SUPPORT_LEDS_LP55231 */
...
#if defined(CONFIG_RTL8198C_I2C_SUPPORT_LEDS_LP5562) || defined(CONFIG_RTL8198C_I2C_SUPPORT_LEDS_LP55231)
	i2c_new_device(&i2c->adap, &wsr30_leds_board_info);
#endif
