...
int h5_init(void)
{
	...
	REG32(0xb800010C) |= (REG32(0xb800010C)&(~(0x3<<23)))|(0x3<<23);
	REG32(0xb8003524) |= (0x1<<27); // direction
	REG32(0xb8003528) &= ~(0x1<<27); // reset data bit
	mdelay(2000);
	REG32(0xb8003528) |= (0x1<<27); // set high
	mdelay(2000);
#else // ori                                                                                        
	/* toggle BT_DISABLE */
	REG32(0xb8000110) |= (0x3<<14);
